...
const BackOptionsBlock = ({ navigation }) => (
  <View style={styles.backOptionsBox}>
    ...
    <TouchableOpacity
      style={styles.optionRowAligned}
      onPress={() =>
        Alert.alert("Info", "Nearby customers feature coming soon")
      }
    >
      {/* Left side */}
      <View style={styles.optionLeft}>
...
mapMiniText: {
  ...
  callBtn:{backgroundColor:"#1e4fa1",padding:14,borderRadius:4,alignItems:"center",flexDirection:"row",justifyContent:"center",marginBottom:10},
